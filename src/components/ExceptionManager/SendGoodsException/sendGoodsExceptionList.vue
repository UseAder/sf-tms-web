                ...
                <div class="J-main-search" >
                    <el-form :inline="true"  :model="searchForm" class="demo-form-inline" ref="searchForm">
                        ...
                        <el-form-item class="J-main-search-button">
                            <el-button type="primary" v-if="checkHasPermission('send_exception:read')" @click='handlesearch'>查询</el-button>
                            <el-button type="warning" v-if="checkHasPermission('send_exception:read')" @click="resetForm('searchForm')">重置</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </div>
            <div :class="trackWaybillVisible?'visibleWaybillList':''">
                <div class="J-elTable-right J-inputWidth">
                    ...
                    <div class="J-elTable-right-waybill">
                        <v-sendGoodsExceptionWaybill @upData="updateData" :waybillNo.sync='chooseData.waybillNo' :waybillId.sync='chooseData.waybillId' :id.sync='chooseData.id' ></v-sendGoodsExceptionWaybill>
                    </div>
                </div>
                <div class="J-elTable-left" id="J-elTable" >
                    <el-table :max-height="getScreenHeight-jElTableOffsetTop>=111?getScreenHeight-jElTableOffsetTop:'none'"  ref="defaultChoiceData" highlight-current-row :data="tableData" border @current-change="currentChangeFun">
                                ...
                                <el-submenu index="1" >
                                    ...
                                    <el-submenu index="2">
                                        ...
                                        <div class="J-flexW" style="width:156px;padding: 0 5px;">
                                            <div v-for="item in managementMark.managementMarkList" :key="item.id" @click="mark(item.id, scope.row,5)">
                                                <el-tooltip 
                                                    class="item"
                                                    effect="dark"
                                                    :content="item.memo"
                       ...
                       <el-table-column label="标记" min-width="80" align="center">
                        ...
                        <el-table-column prop="content" label="异常原因"  min-width='110' align='center'></el-table-column>
                        ...
                        <!-- <el-table-column prop="billTime" label="承运单号" width="150" align='center'></el-table-column> -->
                        ...
                        <el-table-column prop="receiptNum" label="回单" min-width="110" align='center'></el-table-column>
                        ...
                        <el-table-column prop="consignorLinkman" label="发货方" min-width="110" align='center'></el-table-column>
                        ...
                        <el-table-column prop="consigneeLinkmanMobile" label="收货人手机" width="180" align='center'></el-table-column>
                        <el-table-column prop="address" label="收货地址" min-width="205" align='center'></el-table-column>
...
import sendGoodsExceptionWaybill from './SendGoodsExceptionWaybill/sendGoodsExceptionWaybill.vue'
import waybillNoComponent from "@/components/Common/WaybillDetails/waybillNoComponent.vue";

export default {
    name:'e-s-sendGoodsExceptionList',
    mixins: [Base,List,Track],
    components: { 
       'v-sendGoodsExceptionWaybill':sendGoodsExceptionWaybill,
    ...
    methods: {
        ...
        async querySpecialList() {//获取页面初始数据    
            const { code, message,data } =await api.post('/goods/track/send/list', this.searchForm)
            if(code==="200"){
                if(data.records){
