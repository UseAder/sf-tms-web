    ...
    <div class="J-main-body">
      ...
      <div class="J-elTable" id="J-elTable" >        
        <el-table  :max-height="getScreenHeight-jElTableOffsetTop>=111?getScreenHeight-jElTableOffsetTop:'none'"  :data="tableData" border >
          ...
          <el-table-column prop="balanceNo" label="对账结算批次" min-width="120" align='center'>
            <template slot-scope="scope">
          ...
          <!-- <el-table-column prop="driverName" label="司机名称" min-width="110" align='center'></el-table-column> -->
          <el-table-column prop="drayageNum" label="短驳次数" min-width="110" align='center'></el-table-column>
          <el-table-column prop="sumDrayageFee" label="短驳费" min-width="110" align='center'></el-table-column>
          <el-table-column prop="createTime" label="对账时间" min-width="130" align='center'></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //获取页面初始数据
    querySpecialList() {
      api.post('/finance/dra/list', this.searchForm).then(data=>{
        if(data.code==="200"){
