    ...
    <div class="J-main-body">
        ...
        <div class="J-main-search" >
          <el-form :inline="true" :model="searchForm" class="demo-form-inline" ref="searchForm">
              ...
              <el-form-item class="J-main-search-button">
                <el-button type="primary" v-if="checkHasPermission('transfer_audit:read')" @click='handlesearch'>查询</el-button>
                <el-button type="warning" v-if="checkHasPermission('transfer_audit:read')" @click="resetForm('searchForm')">重置</el-button>
              </el-form-item>
          </el-form>
        </div>
      </div>
      <div class="J-elTable" id="J-elTable" >        
        <el-table  :max-height="getScreenHeight-jElTableOffsetTop>=111?getScreenHeight-jElTableOffsetTop:'none'"  :data="tableData" border >
              ...
              <div class="table-menu">
                <el-menu  :collapse="true" v-if="scope.row.status==1" >
                  <el-submenu index="1" >
                    ...
                    <el-menu-item-group> 
                      <el-menu-item index="1-3" v-if="checkHasPermission('transfer_audit:audit')"  @click="newFun(scope.row)">审核</el-menu-item>
                    </el-menu-item-group> 
                  </el-submenu> 
                </el-menu>
              </div>
          ...
          <el-table-column prop="createTime" label="变更时间" min-width="180" align='center'></el-table-column>
          <el-table-column prop="createEmployeeName" label="变更人" min-width="110" align='center'></el-table-column>
          <el-table-column prop="memo" label="变更原因"  min-width="200" align='center'></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async querySpecialList() {
      const { code, message,data } =await api.post('/dis/list', this.searchForm)
      if(code==="200"){
