    ...
    <div class="J-main-body ">
      <div class="homeMain-header"> 
        <div class="J-main-search" >
          <el-form :inline="true" :model="searchForm" class="demo-form-inline" ref="searchForm">
              ...
              <!-- <el-form-item label="承运方" prop="dispatchName">
                <el-input v-model="searchForm.dispatchName" placeholder="承运方"></el-input>
              </el-form-item> -->
      ...
      <div class="J-elTable" id="J-elTable" >        
        <el-table  :max-height="getScreenHeight-jElTableOffsetTop>=111?getScreenHeight-jElTableOffsetTop:'none'"  :data="tableData" border >
          ...
          <el-table-column prop="sumBalanceFee" label="结算金额" width="120" align='center'></el-table-column>
...
export default {
  ...
  methods: {
    ...
    querySpecialList() {
      api.post('/finance/other/list', this.searchForm).then(data=>{
           if(data.code==="200"){
